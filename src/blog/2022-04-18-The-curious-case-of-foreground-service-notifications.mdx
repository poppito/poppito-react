...
When I first got into Android development, background services were kind a little bit [unrestricted](https://android-developers.googleblog.com/2010/02/service-api-changes-starting-with.html)
