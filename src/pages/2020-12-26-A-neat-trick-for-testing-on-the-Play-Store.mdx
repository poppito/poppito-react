...
<img className="image" src= { tester_distribution_list } width="50%"/>
...
<img className="image" src= { tester_link } width="20%"/>
...
<img className="image" src= { switch_accounts } width="20%"/>
<br/>
<br/>
...
<img className="image" src={ play_settings1 } width="15%" />

<br/>
<br/>

<img className="image" src={ play_settings2 } width="15%" />
...
<img className="image" src={ play_store } width="15%" />
...
of your accounts is on the tester distribution list! Just follow the steps above to clear the cache and data for the Play Store app!ß

<img className="image" src= { play_store_gotcha } width="15%" />
